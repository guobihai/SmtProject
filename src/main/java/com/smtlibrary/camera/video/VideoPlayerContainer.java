package com.smtlibrary.camera.video;
...
public class VideoPlayerContainer extends LinearLayout implements OnClickListener
    ...
    private VideoPlayOnCompletion mVideoPlayOnCompletion;
    ...
    public void setVideoPlayOnCompletion(
            VideoPlayOnCompletion mVideoPlayOnCompletion) {
        this.mVideoPlayOnCompletion = mVideoPlayOnCompletion;
    }
...
//		mCurrentTimeView.setText("00:00");
    ...
    public interface VideoPlayOnCompletion {
        //播放后结束播放
        void onExit();
    }
}
