...
import com.smtlibrary.camera.FileOperateUtil;
...
//		mRecordingInfoTextView.setVisibility(View.VISIBLE);
        ...
        if (mCameraView.startRecord()) {
            mHandler.postAtTime(recordRunnable, mRecordingInfoTextView,
    ...
    Runnable recordRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (mCameraView.isRecording()) {
                ...
                mRecordingInfoTextView.setText(mTimeFormat.format(new Date(
                        recordTime)));
                mHandler.postAtTime(this, mRecordingInfoTextView,
    ...
    public Bitmap stopRecord() {
        ...
        String rPath = mCameraView.getmRecordPath();
        paths[0] = mCameraView.getmRecordPath();
        if (thumbnailBitmap != null) {
            ...
            if (null != mListener)
                mListener.onTakeVideoEnd(thumbnailBitmap, paths);
        }
    ...
    public void switchMode(int zoom) {
        ...
        // 自动对焦
        mCameraView.onFocus(new Point(getWidth() / 2, getHeight() / 2),
                autoFocusCallback);
        // 隐藏水印
    ...
    private final PictureCallback pictureCallback = new PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            try {
                ...
                Bitmap bm = mDataHandler.save(data, paths);
                mTempImageView.setListener(mListener);
                ...
                camera.startPreview();
                if (mListener != null)
                    mListener.onTakePictureEnd(bm, paths);
            } catch (Exception e) {
    ...
    private final class DataHandler {
        ...
        public DataHandler() {
            ...
            if (mImageFolder != null && mThumbnailFolder != null) {
         ...
         */
        @SuppressLint("NewApi")
        public Bitmap save(byte[] data, String[] paths) {
            if (data != null) {
                // 解析生成相机返回的图片
        ...
        public Bitmap rotateBitmapByDegree(Bitmap bm, int degree) {
            ...
            try {
                ...
                returnBm = Bitmap.createBitmap(bm, 10, 10, bm.getWidth() - 10,
    ...
    public static interface TakePictureListener {
         ...
         *
         * @param bm    拍照生成的图片
         * @param paths [0]缩列图路径，paths[1] 大图路径
         */
        public void onTakePictureEnd(Bitmap bm, String[] paths);
         ...
         * @param paths [0]缩列图路径，paths[1] 大图路径
         */
        public void onTakeVideoEnd(Bitmap bm, String[] paths);
