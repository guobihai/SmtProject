...
public class FileOperateUtil {
    ...
    private static String imagePath = "/SmtImage/";//图片存放路径
    ...
    public static void setFolderPath(String path) {
        if (!TextUtils.isEmpty(path))
            FileOperateUtil.imagePath = "/" + path + "/";
    }
    ...
    public static String getFolderPath(Context context, int type, String rootPath) {
        ...
        pathBuilder.append(Environment.getExternalStorageDirectory().getAbsolutePath() + imagePath);
